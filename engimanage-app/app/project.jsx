...
const Project = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* create popup */}
      <Dialog.Container visible={createpopUp} contentStyle={{ backgroundColor: "white", borderRadius: 5 }}>
        <Text
          style={{
            fontSize: 20,
            fontWeight: "bold",
      ...
      <Dialog.Container visible={joinpopUp} contentStyle={{ backgroundColor: "white", borderRadius: 5 }}>
        <Text
          style={{
            fontSize: 20,
            fontWeight: "bold",
