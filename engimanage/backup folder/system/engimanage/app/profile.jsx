...
const Profile = () => {
  ...
  const updateProfileImg = async (imageUri, ID) => {
    ...
    if (!imageUri || !ID) return alert("Missing image or user ID");
  ...
  return (
    <ImageBackground style={styles.root} source={{uri:`${link.serverLink}/assets/bg5.png`}} >
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.userRole}>{role.replace(/_/g, " ")}</Text>
